...
if __name__ == "__main__":
    ...
    with open(BASE_DIR + "/templates/ontospy/html/index.html", 'w') as file:
        edited_lines = list()
        for line in lines:
            new_line = line.replace("""Ontology documentation automatically generated by <a class="greylink" href="http://lambdamusic.github.io/Ontospy/">Ontospy</a> on""", "created at: ")
